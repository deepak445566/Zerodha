...
const Positions= require('./schemas/PositionSchema')
...
app.post("/allOrders", async (req, res) => {
  console.log("Received order:", req.body); // ✅ Add this line
  ...
  try {
    await newOrder.save(); // 🔒 Make sure you `await` and wrap in try/catch
...
// path according to your structure
...
app.post("/signup", async (req, res) => {
  ...
  try {
    ...
    await Users.register(newUser, password); // 🔐 Auto hashes & saves password
